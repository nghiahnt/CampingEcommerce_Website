...
const client = require("../../config/redis"); // Error
...
const {
  ...
  verifyRefreshToken,
  resetToken,
} = require("../middlewares/authenticate.js"); // Error
  ...
  resetPassword: async (newPassword, token) => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        if (!decoded) throw createError.Unauthorized(err.message);
